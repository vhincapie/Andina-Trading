...
public class Comisionista {
    ...
    public Comisionista(Long id, Long usuarioId, String nombre, String apellido, String correo, String tipoDocumento, String numeroDocumento, LocalDate fechaNacimiento, Long paisId, Long ciudadId, Integer aniosExperiencia) {
        this.id = id;
