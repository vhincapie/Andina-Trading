...
public class OrdenFilledEmailRequest {
    ...
    public OrdenFilledEmailRequest() {
    }

    public OrdenFilledEmailRequest(Long orderDbId, String symbol, String side, String qty, BigDecimal unitPrice, BigDecimal netAmount, String moneda, Instant filledAt, String inversionistaNombre, String inversionistaCorreo) {
        ...
        this.moneda = moneda;this.filledAt = filledAt;
