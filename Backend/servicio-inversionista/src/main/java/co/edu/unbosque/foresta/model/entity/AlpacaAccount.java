...
public class AlpacaAccount {
    ...
    @OneToOne
    @JoinColumn(name = "id_inversionista", referencedColumnName = "id", nullable = false, unique = true)
    ...
    public AlpacaAccount(Long id, String alpacaId, String status, String currency, Inversionista inversionista, LocalDateTime createdAt) {
        this.id = id;
