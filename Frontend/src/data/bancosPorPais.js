export const bancosPorPais = {
  ...
  VE: [
    { id: "ven", nombre: "Banco de Venezuela" },
    { id: "prov", nombre: "Banco Provincial" },
    { id: "banco-bod", nombre: "BOD" },
  ],
  US: [
    { id: "boa", nombre: "Bank of America" },
    { id: "chase", nombre: "Chase" },
    { id: "wells", nombre: "Wells Fargo" },
  ],
};
